...
const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 sm:w-1/2 w-full h-full bg-white flex flex-col justify-between shadow-lg transform transition-transform duration-500 z-40 ${
